// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BirdEyeView_Bilinear_V1\BirdEyeViewImproved_ip_fifo_eol_classic.v
...
// -------------------------------------------------------------
// 
// Module: BirdEyeViewImproved_ip_fifo_eol_classic
// Source Path: BirdEyeViewImproved_ip/BirdEyeViewImproved_ip_axi4_stream_video_slave/BirdEyeViewImproved_ip_fifo_eol/BirdEyeViewImproved_ip_fifo_eol_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module BirdEyeViewImproved_ip_fifo_eol_classic
  ...
  BirdEyeViewImproved_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                                     ...
                                                     u_BirdEyeViewImproved_ip_fifo_eol_classic_ram (.clk(clk),
                                                                                                    .enb(enb),
                                                                                                    .wr_din(In),  // ufix1
                                                                                                    .wr_addr(w_waddr),
                                                                                                    .wr_en(w_we),  // ufix1
...
endmodule  // BirdEyeViewImproved_ip_fifo_eol_classic
