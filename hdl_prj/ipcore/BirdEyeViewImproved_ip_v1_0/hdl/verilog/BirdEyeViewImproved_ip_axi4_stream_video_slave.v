// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BirdEyeView_Bilinear_V1\BirdEyeViewImproved_ip_axi4_stream_video_slave.v
...
// -------------------------------------------------------------
// 
// Module: BirdEyeViewImproved_ip_axi4_stream_video_slave
// Source Path: BirdEyeViewImproved_ip/BirdEyeViewImproved_ip_axi4_stream_video_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module BirdEyeViewImproved_ip_axi4_stream_video_slave
  ...
  BirdEyeViewImproved_ip_fifo_eol u_BirdEyeViewImproved_ip_fifo_eol_inst (.clk(clk),
                                                                          .reset(reset),
                                                                          .enb(enb),
  ...
  BirdEyeViewImproved_ip_fifo_sof u_BirdEyeViewImproved_ip_fifo_sof_inst (.clk(clk),
                                                                          .reset(reset),
                                                                          .enb(enb),
  ...
  BirdEyeViewImproved_ip_adapter_in u_BirdEyeViewImproved_ip_BirdEyeViewImproved_ip_axi4_stream_video_slave_BirdEyeViewImproved_ip_adapter_in (.clk(clk),
                                                                                                                                               .reset(reset),
  ...
  BirdEyeViewImproved_ip_fifo_data u_BirdEyeViewImproved_ip_fifo_data_inst (.clk(clk),
                                                                            .reset(reset),
                                                                            .enb(enb),
...
endmodule  // BirdEyeViewImproved_ip_axi4_stream_video_slave
