// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BirdEyeView_Bilinear_V1\BirdEyeViewImproved_ip_axi4_stream_video_master.v
...
// -------------------------------------------------------------
// 
// Module: BirdEyeViewImproved_ip_axi4_stream_video_master
// Source Path: BirdEyeViewImproved_ip/BirdEyeViewImproved_ip_axi4_stream_video_master
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module BirdEyeViewImproved_ip_axi4_stream_video_master
  ...
  BirdEyeViewImproved_ip_fifo_data_OUT u_BirdEyeViewImproved_ip_fifo_data_OUT_inst (.clk(clk),
                                                                                    .reset(reset),
                                                                                    .enb(enb),
  ...
  BirdEyeViewImproved_ip_fifo_eol_out u_BirdEyeViewImproved_ip_fifo_eol_out_inst (.clk(clk),
                                                                                  .reset(reset),
                                                                                  .enb(enb),
  ...
  BirdEyeViewImproved_ip_fifo_sof_out u_BirdEyeViewImproved_ip_fifo_sof_out_inst (.clk(clk),
                                                                                  .reset(reset),
                                                                                  .enb(enb),
...
endmodule  // BirdEyeViewImproved_ip_axi4_stream_video_master
