// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BirdEyeView_Bilinear_V1\BirdEyeViewImproved_ip_fifo_sof_out_classic.v
...
// -------------------------------------------------------------
// 
// Module: BirdEyeViewImproved_ip_fifo_sof_out_classic
// Source Path: BirdEyeViewImproved_ip/BirdEyeViewImproved_ip_axi4_stream_video_master/BirdEyeViewImproved_ip_fifo_sof_out/BirdEyeViewImproved_ip_fifo_sof_out_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module BirdEyeViewImproved_ip_fifo_sof_out_classic
  ...
  BirdEyeViewImproved_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                                       .DataWidth(1)
                                                       )
                                                     u_BirdEyeViewImproved_ip_fifo_sof_out_classic_ram_singlebit (.clk(clk),
                                                                                                                  .enb(enb),
                                                                                                                  .wr_din(In),  // ufix1
                                                                                                                  .wr_addr(w_waddr),
                                                                                                                  .wr_en(w_we),  // ufix1
...
endmodule  // BirdEyeViewImproved_ip_fifo_sof_out_classic
