// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BirdEyeView_Bilinear_V1\BirdEyeViewImproved_ip_fifo_data_OUT_classic.v
...
// -------------------------------------------------------------
// 
// Module: BirdEyeViewImproved_ip_fifo_data_OUT_classic
// Source Path: BirdEyeViewImproved_ip/BirdEyeViewImproved_ip_axi4_stream_video_master/BirdEyeViewImproved_ip_fifo_data_OUT/BirdEyeViewImproved_ip_fifo_data_OUT_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module BirdEyeViewImproved_ip_fifo_data_OUT_classic
  ...
  BirdEyeViewImproved_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                                     .DataWidth(32)
                                                     )
                                                   u_BirdEyeViewImproved_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                                               .enb(enb),
                                                                                                               .wr_din(In),
                                                                                                               .wr_addr(w_waddr),
                                                                                                               .wr_en(w_we),  // ufix1
...
endmodule  // BirdEyeViewImproved_ip_fifo_data_OUT_classic
